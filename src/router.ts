// @routes-hash 5b4dcd9ee97003a7a3cc25c24e5e7505
...
import route41 from "./routes/production/getProductionData";
import route42 from "./routes/production/getStoryboardData";
import route43 from "./routes/production/workbench/generateVideo";
import route44 from "./routes/production/workbench/getVideoModelDetail";
...
export default async (app: Express) => {
  ...
  app.use("/api/production/getProductionData", route41);
  app.use("/api/production/getStoryboardData", route42);
  app.use("/api/production/workbench/generateVideo", route43);
  app.use("/api/production/workbench/getVideoModelDetail", route44);
